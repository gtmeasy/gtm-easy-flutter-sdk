...
class WebhooksApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GenericOkResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericOkResponse>> webhookAppstorePost({
    required AppStoreWebhookRequest appStoreWebhookRequest,
    ...
    GenericOkResponse? _responseData;
    ...
    return Response<GenericOkResponse>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [GenericOkResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericOkResponse>> webhookPlaystorePost({
    required PlayStoreWebhookRequest playStoreWebhookRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
